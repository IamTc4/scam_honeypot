...
class PPOHoneypotAgent:
    ...
    def __init__(self, state_dim=256, action_dim=10, lr=3e-4, gamma=0.99, epsilon=0.2):
        ...
        self.action_space = {
            0: {"type": "ask_clarification", "compliance": 0.2, "detail": "high"},
            1: {"type": "express_confusion", "compliance": 0.3, "detail": "medium"},
            2: {"type": "show_fear", "compliance": 0.7, "detail": "low"},
            3: {"type": "ask_verification", "compliance": 0.4, "detail": "high"},
            4: {"type": "partial_compliance", "compliance": 0.6, "detail": "medium"},
            5: {"type": "express_doubt", "compliance": 0.1, "detail": "high"},
            6: {"type": "stall_time", "compliance": 0.5, "detail": "low"},
            7: {"type": "ask_details", "compliance": 0.3, "detail": "high"},
            8: {"type": "show_urgency", "compliance": 0.8, "detail": "low"},
            9: {"type": "request_help", "compliance": 0.4, "detail": "medium"}
        }
    ...
    def compute_reward(self, session_update: Dict) -> float:
        ...
        # Positive rewards
        reward += session_update.get('new_intel_count', 0) * 1.0
        reward += session_update.get('new_critical_intel', 0) * 5.0
        
        # Negative rewards
        if session_update.get('detected', False):
            reward -= 10.0
        
        # Bonus for successful completion
        if session_update.get('conversation_ended', False) and not session_update.get('detected', False):
            reward += 3.0
